...
const Home = () => {
 const labels = ['New RFQs','Ordered','Quoted RFQs','Order Lost','Declined RFQs','Cancelled']; // default label
  ...
  return (
    <>
      {/* <Card/> */}
      <Chart labels={labels} dataValues={dataValues} activePrLabel={activePrLabel} title={title} />      
    </>
  );
};
